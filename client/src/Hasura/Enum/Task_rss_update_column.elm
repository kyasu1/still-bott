...
module Hasura.Enum.Task_rss_update_column exposing (..)

import Json.Decode as Decode exposing (Decoder)


{-| update columns of table "task\_rss"
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Task_rss_update_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Task_rss_update_column -> String
toString enum____ =
    case enum____ of
        Created_at ->
            "created_at"
...
-}
fromString : String -> Maybe Task_rss_update_column
