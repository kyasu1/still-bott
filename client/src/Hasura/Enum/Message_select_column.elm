...
module Hasura.Enum.Message_select_column exposing (..)
        ...
        |> Decode.andThen
            (\string ->
                case string of
                    ...
                    _ ->
                        Decode.fail ("Invalid Message_select_column type, " ++ string ++ " try re-running the @dillonkearns/elm-graphql CLI ")
            )


{-| Convert from the union type representing the Enum to a string that the GraphQL server will recognize.
-}
toString : Message_select_column -> String
toString enum____ =
    case enum____ of
        Created_at ->
            "created_at"
...
-}
fromString : String -> Maybe Message_select_column
