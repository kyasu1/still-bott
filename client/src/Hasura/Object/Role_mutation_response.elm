...
module Hasura.Object.Role_mutation_response exposing (..)
...
-}
affected_rows : SelectionSet Int Hasura.Object.Role_mutation_response
affected_rows =
...
returning :
    ...
    -> SelectionSet (List decodesTo) Hasura.Object.Role_mutation_response
