...
module Hasura.Object.Session_aggregate_fields exposing (..)
...
avg :
    SelectionSet decodesTo Hasura.Object.Session_avg_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
avg object____ =
    Object.selectionForCompositeField "avg" [] object____ (Basics.identity >> Decode.nullable)


type alias CountOptionalArguments =
    { columns : OptionalArgument (List Hasura.Enum.Session_select_column.Session_select_column)
...
count :
    ...
    -> SelectionSet Int Hasura.Object.Session_aggregate_fields
count fillInOptionals____ =
    let
        ...
        optionalArgs____ =
            [ Argument.optional "columns" filledInOptionals____.columns (Encode.enum Hasura.Enum.Session_select_column.toString |> Encode.list), Argument.optional "distinct" filledInOptionals____.distinct Encode.bool ]
...
max :
    SelectionSet decodesTo Hasura.Object.Session_max_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
max object____ =
...
min :
    SelectionSet decodesTo Hasura.Object.Session_min_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
min object____ =
...
stddev :
    SelectionSet decodesTo Hasura.Object.Session_stddev_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
stddev object____ =
...
stddev_pop :
    SelectionSet decodesTo Hasura.Object.Session_stddev_pop_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
...
stddev_samp :
    SelectionSet decodesTo Hasura.Object.Session_stddev_samp_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
...
sum :
    SelectionSet decodesTo Hasura.Object.Session_sum_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
sum object____ =
...
var_pop :
    SelectionSet decodesTo Hasura.Object.Session_var_pop_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
var_pop object____ =
...
var_samp :
    SelectionSet decodesTo Hasura.Object.Session_var_samp_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
var_samp object____ =
...
variance :
    SelectionSet decodesTo Hasura.Object.Session_variance_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Session_aggregate_fields
variance object____ =
