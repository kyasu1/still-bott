...
module Hasura.Object.Task_rss_max_fields exposing (..)
...
created_at : SelectionSet (Maybe ScalarCodecs.Timestamptz) Hasura.Object.Task_rss_max_fields
created_at =
...
id : SelectionSet (Maybe ScalarCodecs.Uuid) Hasura.Object.Task_rss_max_fields
id =
...
last_pub_date : SelectionSet (Maybe ScalarCodecs.Timestamptz) Hasura.Object.Task_rss_max_fields
last_pub_date =
...
template : SelectionSet (Maybe String) Hasura.Object.Task_rss_max_fields
template =
    Object.selectionForField "(Maybe String)" "template" [] (Decode.string |> Decode.nullable)


updated_at : SelectionSet (Maybe ScalarCodecs.Timestamptz) Hasura.Object.Task_rss_max_fields
updated_at =
...
url : SelectionSet (Maybe String) Hasura.Object.Task_rss_max_fields
url =
    Object.selectionForField "(Maybe String)" "url" [] (Decode.string |> Decode.nullable)


user_id : SelectionSet (Maybe String) Hasura.Object.Task_rss_max_fields
user_id =
