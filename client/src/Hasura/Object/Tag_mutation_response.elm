...
module Hasura.Object.Tag_mutation_response exposing (..)
...
-}
affected_rows : SelectionSet Int Hasura.Object.Tag_mutation_response
affected_rows =
...
returning :
    ...
    -> SelectionSet (List decodesTo) Hasura.Object.Tag_mutation_response
