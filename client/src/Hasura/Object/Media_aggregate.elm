...
module Hasura.Object.Media_aggregate exposing (..)
...
aggregate :
    SelectionSet decodesTo Hasura.Object.Media_aggregate_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Media_aggregate
...
nodes :
    ...
    -> SelectionSet (List decodesTo) Hasura.Object.Media_aggregate
nodes object____ =
