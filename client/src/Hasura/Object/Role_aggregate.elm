...
module Hasura.Object.Role_aggregate exposing (..)
...
aggregate :
    SelectionSet decodesTo Hasura.Object.Role_aggregate_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Role_aggregate
...
nodes :
    ...
    -> SelectionSet (List decodesTo) Hasura.Object.Role_aggregate
nodes object____ =
