...
module Hasura.Object.Message_aggregate exposing (..)
...
aggregate :
    SelectionSet decodesTo Hasura.Object.Message_aggregate_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.Message_aggregate
...
nodes :
    ...
    -> SelectionSet (List decodesTo) Hasura.Object.Message_aggregate
nodes object____ =
