...
module Hasura.Object.User_aggregate exposing (..)
...
aggregate :
    SelectionSet decodesTo Hasura.Object.User_aggregate_fields
    -> SelectionSet (Maybe decodesTo) Hasura.Object.User_aggregate
...
nodes :
    ...
    -> SelectionSet (List decodesTo) Hasura.Object.User_aggregate
nodes object____ =
